...
export function StickyBookingCTA({ pricePerDay, isLoggedIn, itemId }: Props) {
  ...
  return (
    <div
      className="fixed bottom-[72px] left-0 right-0 z-[150] flex items-center justify-between gap-4 border-t border-border bg-surface px-4 py-3 shadow-[0_-4px_16px_rgba(0,0,0,.1)] lg:hidden"
      role="complementary"
