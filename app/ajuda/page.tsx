...
const SECTIONS = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Existem limites de valor no ShareO?",
        a: "Sim, dois limites se aplicam nesta primeira fase. (1) Valor do bem: itens com valor estimado acima de R$ 1.000 não podem ser anunciados — esse limite existe para adequar o perfil de risco dos aluguéis enquanto a plataforma está em fase inicial. (2) Valor por locação: o total de cada transação não pode ultrapassar R$ 500 — se o valor calculado exceder esse teto, o checkout é bloqueado com uma mensagem orientando o locatário a reduzir o período ou negociar diretamente." },
