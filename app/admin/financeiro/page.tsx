        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Decisão ADR-028 (19/08/2026): Stripe Connect é o PSP definitivo, com split de {100 - currentFeeRate / 100}% para o proprietário e {currentFeeRate / 100}% para a ShareO. Construído: onboarding Express do proprietário, repasse automático via Transfer, checkout com cartão/Pix/boleto e reversão em reembolso. Falta ir a produção (bloqueado pelo D4 jurídico). Mercado Pago (ADR-026) segue dormente, código preservado.
            </p>
          </div>
          <span className="rounded-full border border-border px-2.5 py-0.5 text-xs font-medium text-muted-foreground">
            Construído, aguardando D4
          </span>
        </div>
      </div>
    </div>
