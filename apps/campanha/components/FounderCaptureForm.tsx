...
export function FounderCaptureForm({ defaultCity, defaultUf, campaign, startExpanded }: Props = {}) {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    try {
      ...
      // LGPD) e para a chave de rate limit; um proxy server-side daqui gravaria
      // o IP desta função como se fosse o do usuário. Ver lib/config.ts.
      const res = await fetch(ROTAS.leads, {
        method:  "POST",
    ...
    <div className="relative mx-auto max-w-[400px] p-2">
      ...
      <div>
        ...
        {/*
          ...
          formulário inteiro) — achado do Thiago em 13/09: a versão antiga
          trocava a tela toda por um aviso solto, longe do campo que causou o
          409, e sem nenhum destaque visual de alerta.
        */}
