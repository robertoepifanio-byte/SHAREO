/**
 * Ícones de interface da landing. Mesma família visual dos ícones de item:
 * traço de 2px sobre viewBox 24, `currentColor`, sem preenchimento.
 *
 * Inline pelo mesmo motivo do ItemIcon — e porque a landing não instala
 * `lucide-react` só para desenhar nove formas.
 */
