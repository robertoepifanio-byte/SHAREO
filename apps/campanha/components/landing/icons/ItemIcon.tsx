/**
 * Ícones de item — cópia de components/home/icons/ProcuradoIcon.tsx da raiz.
 *
 * É cópia e não import porque este app é independente do marketplace (não há
 * alias de workspace apontando para a raiz). São SVGs inline: herdam
 * `currentColor` e não custam nenhum request — o que importa numa landing de
 * mídia paga, onde cada asset extra atrasa a primeira pintura.
 */
