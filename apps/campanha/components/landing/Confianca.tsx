...
/**
 * A objeção número um de quem tem itens parados, dita com as palavras dela.
 *
 * O título é a pergunta literal que trava o cadastro — "e se eu emprestar para
 * um desconhecido?". Enunciar a objeção antes de respondê-la é mais eficaz do
 * que um título institucional de "Segurança", porque prova que a pergunta foi
 * antecipada.
 *
 * Nenhum pilar cita prazo, valor ou percentual: seriam promessas mensuráveis
 * sobre um serviço que ainda não opera.
 */
