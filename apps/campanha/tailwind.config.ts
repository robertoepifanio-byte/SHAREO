...
const config: Config = {
  ...
  content: [
    ...
    // tabular-nums no CNPJ e sem a caixa de contato. Aqui o estrago é maior que
    // na raiz, onde várias dessas classes sobrevivem por acaso (outras telas
    // do marketplace as usam).
