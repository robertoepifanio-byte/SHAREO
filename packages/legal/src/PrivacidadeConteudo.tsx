...
/**
 * Corpo da Política de Privacidade. Fonte única: renderizado pelo marketplace
 * (app/privacidade) e pela landing da campanha (apps/campanha/app/privacidade).
 *
 * É o documento que a revisão de anúncios do Meta e do Google exige que esteja
 * acessível a partir de qualquer página que capte dados — por isso a campanha
 * publica o seu próprio, em vez de mandar o visitante para o site.
 */
export function PrivacidadeConteudo({ atualizadoEm }: { atualizadoEm: string }) {
