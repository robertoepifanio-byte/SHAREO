import { LEGAL_ENTITY } from "./entidade"

/**
 * Bloco de identificação do prestador, renderizado em /termos, /privacidade e
 * /politicas — no marketplace e na landing da campanha. A obrigação legal e o
 * motivo da fonte única estão documentados uma vez, na JSDoc de `LEGAL_ENTITY`
 * (./entidade.ts).
 *
