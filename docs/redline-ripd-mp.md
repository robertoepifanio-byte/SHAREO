...
1. Aplicar as edicoes P0 em `docs/rascunho-ripd.md` (Edicoes 1, 2, 4 podem ser aplicadas imediatamente — nao dependem da integracao tecnica do MP estar completa; Edicoes 3 e 5 dependem do contrato MP assinado e da integracao funcional).
