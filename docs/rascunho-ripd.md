...
| F-06 | Transferencia internacional sem adequacao formal | Medio | Alto | Dados persistidos em sa-east-1 (Brasil); subprocessadores EUA para funcoes auxiliares limitadas | Formalizar DPAs e/ou clausulas contratuais padrao com Resend, Sentry, Mapbox e Vercel (ver `docs/transferencia-internacional-dados.md`) |
...
| Informacao sobre compartilhamento | Art. 18 VII | Politica de Privacidade + `docs/transferencia-internacional-dados.md` | /privacidade |
...
3. **Formalizar DPAs com subprocessadores internacionais** (ver `docs/transferencia-internacional-dados.md`).
