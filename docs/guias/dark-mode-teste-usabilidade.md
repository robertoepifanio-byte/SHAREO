...
**Referência:** `docs/planos/dark-mode-plan.md` (§8 protótipos/validação, §9 checklist)
...
Se um critério falhar, registrar o achado, priorizar a correção e (se for de UI) reabrir uma rodada curta da fase correspondente (ver `docs/planos/dark-mode-plan.md`).
...
- Anexar ao acompanhamento do projeto e atualizar o checklist §9 do `docs/planos/dark-mode-plan.md` (item "Testes de usabilidade").
