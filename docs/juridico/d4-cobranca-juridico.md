...
>     - **(c)** ⛔ **A PREMISSA DESTA ALÍNEA É FALSA — apurado em 04/09/2026.** O GA4 **nunca esteve em uso**. A pergunta como enviada supõe um analytics de primeira parte que não existe, e o próprio documento diz que a resposta a (c) **define o escopo do banner de cookies** — ou seja, o escopo estava sendo definido por um fato inexistente. **Reformular antes de aceitar a resposta:** hoje não há ferramenta de analytics; há apenas contagem agregada de visualizações por anúncio, dentro da plataforma. Ver [`dpa-apuracao-2026-09-03.md`](dpa-apuracao-2026-09-03.md) §3.1. ~~O GA4 já em uso (primeira parte, IP anonimizado) demanda o mesmo tratamento, ou a distinção entre analytics próprio e compartilhamento com terceiro altera a resposta?~~
>
