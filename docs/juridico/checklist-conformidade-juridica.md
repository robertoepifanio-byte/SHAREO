...
2. 🟢 **Relação com o PSP formalizada + conta PJ ativa** — **conta PJ ativa** (CNPJ 68.512.556/0001-09, desde 11/08/2026). O **contrato do Mercado Pago deixou de existir como pendência** em 24/08/2026: o MP foi descartado e a Stripe se formaliza por aceitação eletrônica no cadastro, sem instrumento assinado à parte. **Resta confirmar** que a conta plataforma na Stripe está no **CNPJ da PJ** (e não em CPF de sócio) — é a titularidade que sustenta "a ShareO não é merchant of record".
3. ✅(conteúdo) **Termos de Uso e Política de Privacidade revisados** — **conteúdo APROVADO p/ publicação no go-live** (resposta D1); **publicar só no go-live**. ⚠️ Os rascunhos ([`draft-clausulas-mp-termos-privacidade.md`](draft-clausulas-mp-termos-privacidade.md)) nomeiam o **Mercado Pago** como operador — reescrever para a Stripe **junto** com a análise de transferência internacional, não antes dela. A **identificação da PJ** (razão social + CNPJ) já está publicada em `/termos`, `/privacidade` e `/politicas` desde 24/08; falta o **endereço da sede**.
...
| **B1** 🔒 | 🟢 **Quase fechado (2026-08-24).** As duas metades do B1 eram *(a)* constituir a PJ e *(b)* contratar o PSP. **(a) está feita:** CNPJ **68.512.556/0001-09 ativo desde 11/08/2026**, CNAE 74.90-1-04 (intermediação), coerente com o parecer. **(b) mudou de objeto:** o Mercado Pago **não será utilizado** (decisão do fundador, 24/08/2026) — o PSP é a **Stripe** ([[ADR-028]]). Com isso o "contrato MP assinado", que era a metade travada, **deixa de existir como pendência**: a Stripe não tem contrato de split para assinar à parte; a relação se formaliza pela aceitação eletrônica do Stripe Services Agreement no cadastro da conta plataforma. **Resta confirmar:** que essa conta plataforma esteja no **CNPJ da PJ**, e não em CPF de sócio — é o que sustenta o desenho de "ShareO não é merchant of record". | Fundador Raimundo — confirmar a titularidade PJ da conta Stripe. |
...
| **B3** | 🟡 **Contabilizei contratada** (2026-08-05) — abertura de empresa + definição do regime tributário (Simples/Presumido/Real) no mesmo escopo. **A abertura saiu: CNPJ ativo desde 11/08/2026.** Falta o **regime tributário** definido. | Contabilizei (execução) + Fundador Raimundo. |
