...
- 🔴 **Formalizar transferência internacional** (Stripe/Vercel/Resend/Sentry/Mapbox/Upstash/GA4 — EUA) — **fora do prazo legal**. As **CPC da ANPD** (Res. 19/2024) venceram em **23/08/2025** e não se "assinam": adotam-se na íntegra. Medidos os sete fornecedores em 03/09: **só a Stripe adota as CPC**. Vercel, Resend, Sentry, Mapbox, Upstash e Google Analytics **não publicam**; Supabase depende de definir se há transferência. Falta ainda o **documento público da Cláusula 14**, obrigação nossa. Ver [`dpa-apuracao-2026-09-03.md`](dpa-apuracao-2026-09-03.md).
...
4. 🔨 **Checklist acima 100% cumprido** — destravado pelas respostas de 2026-06-30 (ver abaixo). ~~B3 tributarista~~ **fechado em 03/09 (Simples Nacional, via Contabilizei)**; restam **C2** (não é mais "o DPA da Stripe" — ver abaixo), **C3 RIPD/DPO**, mais a **ressalva do PSP** (o parecer analisou o Mercado Pago, não a Stripe) — ver [`ressalva-psp-stripe-2026-09-03.md`](ressalva-psp-stripe-2026-09-03.md) e [`dpa-apuracao-2026-09-03.md`](dpa-apuracao-2026-09-03.md).
...
| **C2** | 🔴 **Responsável nomeado (2026-08-04): Raimundo Gomes da Silva.** Reenquadrado em **03/09/2026** ([`dpa-apuracao-2026-09-03.md`](dpa-apuracao-2026-09-03.md)) — o pendente **não é** "assinar DPAs": **Stripe ✅** (adota as CPC da ANPD, nada a assinar) · **Vercel/Resend/Sentry/Mapbox/Upstash/GA4 ❌** (sem CPC — decisão da **advogada**; o GA4 é o único **não essencial**, e desligá-lo resolve sem ela) · **Supabase ❓** (definir se há transferência) · **Cláusula 14** 🔨 (rascunho pronto, obrigação nossa). | Decisões dos fornecedores: **advogada**. Cláusula 14 e medições: **equipe técnica**. Coordenação: Raimundo. |
