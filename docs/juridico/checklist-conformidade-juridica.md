...
- 🔴 **Formalizar transferência internacional** (Stripe/Vercel/Resend/Sentry/Mapbox/Upstash/GA4 — EUA) — **fora do prazo legal**. As **CPC da ANPD** (Res. 19/2024) venceram em **23/08/2025** e não se "assinam": adotam-se na íntegra. **Stripe ✅ já adota**; Vercel, Resend e Sentry **não publicam CPC**; Supabase, Mapbox, Upstash e GA4 **não foram medidos**. Falta ainda o **documento público da Cláusula 14**, obrigação nossa. Ver [`dpa-apuracao-2026-09-03.md`](dpa-apuracao-2026-09-03.md).
