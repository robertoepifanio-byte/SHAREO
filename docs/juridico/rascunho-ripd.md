...
| F-06 | Transferencia internacional sem adequacao formal | Medio | Alto | Dados persistidos em sa-east-1 (Brasil); subprocessadores EUA para funcoes auxiliares limitadas | **Revisto em 03/09/2026 — a mitigacao anterior nao satisfaz a norma vigente.** As **CPC da ANPD** (Res. CD/ANPD 19/2024) sao obrigatorias e o prazo venceu em **23/08/2025**; DPA com SCC da UE nao basta. Situacao real: **Stripe adota as CPC**; **Vercel, Resend e Sentry nao publicam CPC** (decisao pendente da advogada); **Supabase, Mapbox, Upstash e GA4 nao medidos**. Pendencia adicional: publicar o **documento da Clausula 14** (obrigacao do exportador). Ver `docs/juridico/dpa-apuracao-2026-09-03.md` |
