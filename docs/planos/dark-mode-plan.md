...
**Testes de usabilidade:** *(roteiro pronto em [`docs/guias/dark-mode-teste-usabilidade.md`](../guias/dark-mode-teste-usabilidade.md) — execução pelos fundadores no staging)*
