...
- Mobile: **reservar+pagar**, **anunciar**, **KYC/biometria**, mapa, favoritos (funcionalidades novas — ver `docs/plano-mobile-lojas.md`).
...
*Fonte da verdade desta meta. Ver `docs/STATUS.md`, `docs/backlog-atividades-priorizadas.md`, `docs/checklist-conformidade-juridica.md`.*
