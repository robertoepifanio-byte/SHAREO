...
- **23/09/2026 — preparado pelo técnico, nada fechado:**
  - 🟡 **GTM declarado** nas duas Políticas (site, campanha e app) e teste que reprova se o GTM ficar ligado sem declaração. **Mesclado em 24/09 (#498) e no ar em shareo.com.br** (conferido: `/politicas` e `/privacidade` citam o Google Tag Manager). O app mobile só recebe o texto no próximo build. **A advogada ainda decide se basta.**
