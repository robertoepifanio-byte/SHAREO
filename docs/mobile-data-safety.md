...
**Nota LGPD / transferência internacional:** Resend, Mapbox, Expo e Sentry operam nos EUA. A transferência internacional de dados deve estar coberta nos Termos de Uso e na Política de Privacidade (item em andamento no checklist de conformidade, gated D4). Ver `docs/checklist-conformidade-juridica.md`.
