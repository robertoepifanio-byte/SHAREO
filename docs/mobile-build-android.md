...
Ver `docs/mobile-build-android-hipoteses-gradle.md` para analise completa das hipoteses de falha do Gradle.
...
*Fase 1 do plano `docs/meta-app-android-build.md`. O disparo do build e externo — requer acesso a conta Expo dos fundadores.*
