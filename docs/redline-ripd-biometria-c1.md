...
**Status no produto:** **gated D4** — codigo nao alterado; consentimento destacado ainda **nao implementado**. Spec em `docs/spec-consentimento-biometria-c1.md`.

---

## 1. Redline da Secao C.3 — Dados de verificacao de identidade

A tabela atual em `docs/rascunho-ripd.md` (Secao C.3, linhas 83-92) classifica a selfie como "Dado pessoal — imagem (potencialmente biometrico)" com base legal art. 7o IX. **Substituir por:**
...
1. Implementar consentimento especifico e destacado para a selfie, conforme `docs/spec-consentimento-biometria-c1.md` — **gated D4**.
