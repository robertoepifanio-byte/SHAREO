...
**Atualizado em**: 2026-06-21 (sessão s32 — **carrinho de locação multi-item do mesmo dono** (Story B/ADR-025, Fases 1–5 prontas na branch `feat/multi-item-booking-same-owner`, E2E pendente) + lote de UX p/ tester (onboarding /bem-vindo, descoberta da importação PJ, copy /sobre); s31 = modo escuro no staging; histórico s13–s31 abaixo)
