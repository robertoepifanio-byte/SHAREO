...
**Atualizado em**: 2026-06-16 (sessão s20 — CI 100% verde [Lighthouse/drift/contraste/E2E] + fix de segurança da Data API do Supabase; histórico s13–s19 abaixo)
