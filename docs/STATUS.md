...
**Atualizado em**: 2026-06-19 (sessão s30 — planejamento do **modo escuro** (dark mode): spec v0.2 + protótipo HTML, revisado por designer-shareo + fullstack-dev-shareo; s29 = campanha #50 + migração Vercel corporativa + Zoho + release v1.8.0; histórico s13–s29 abaixo)
...
**Último commit**: `534d1db` (s29 — bump v1.8.0). **Nenhum PR aberto restante.** CI da main verde + Deploy Staging verde sob o Team corporativo.
