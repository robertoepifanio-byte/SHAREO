...
**Atualizado em**: 2026-06-18 (sessão s26 — base de validação demo no staging + busca de usuários no admin + lote de UX/copy; histórico s13–s25 abaixo)
...
**Último commit**: `d4e4117` (s26: busca da ajuda sem auto-scroll PR #45; antes: lote UX/copy PR #44 `8db7639`, scripts da base demo PR #43 `08873d6`, Termos taxa/repasse PR #42 `521f8d2`, busca de usuários admin PR #41 `6ce5792`)
