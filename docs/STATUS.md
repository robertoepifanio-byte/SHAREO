...
**Atualizado em**: 2026-06-17 (sessão s24 — pré-lançamento: painel de pilotos por cidade + onboarding `/bem-vindo`; ajustes do tester na precificação do anúncio; UX config embaixadores; remoção de frases de pagamento; histórico s13–s23 abaixo)
...
**Último commit**: `9f0c258` (s24: remove frases de pagamento PR #40; antes: pré-lançamento PR #38 `6b9bb7f`, auto-recalc preço PR #39 `3d9c4d6`, sugestão preço PR #37 `6bf90fd`, UX embaixadores PR #36 `6af74e3`) — ⚠️ **deploy do #40 pendente** (limite diário Vercel free, re-disparar ~18/06)
