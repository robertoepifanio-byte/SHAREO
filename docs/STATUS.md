...
**Atualizado em**: 2026-06-17 (sessão s23 — correções do painel admin: logout indevido [blocklist→epoch] + 404 do "Ver conversa" na disputa; robô daily-sim resiliente a 429; histórico s13–s22 abaixo)
...
**Último commit**: `0a1674b` (s23: "Ver conversa" da disputa read-only — PR #34; antes: blocklist→epoch PR #33 `da9e3d6`, robô 429 PR #32 `fe36065`, senha admin no CLAUDE.md `18b5f55`)
