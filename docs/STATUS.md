...
**Atualizado em**: 2026-06-17 (sessão s22 — fix de comissão na reserva + copy do rodapé; Robô de Validação Diária; release v1.6.0 e histórico s13–s21 abaixo)
...
**Último commit**: `4278af1` (s22: fix do robô daily-sim — PR #29; antes: comissão+rodapé PR #27 `0bd57d5`, robô PR #28 `9271f75`; release v1.6.0 `746d718`)
