...
**Atualizado em**: 2026-06-16 (sessão s21 — release v1.6.0: cadastro progressivo + melhorias LGPD + convite-piloto; histórico s13–s20 abaixo)
...
**Último commit**: `746d718` (release v1.6.0; feature em `66bcef7` / PR #26)
