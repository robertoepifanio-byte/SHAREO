...
**Atualizado em**: 2026-06-19 (sessão s29 — campanha UTM/canal + landings `/pilotos/[cidade]` #50 + migração do Vercel para conta corporativa SHAREO Marketplace (Pro) + caixas humanas no Zoho + release v1.8.0; histórico s13–s28 abaixo)
