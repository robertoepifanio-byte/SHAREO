...
2. **RIPD** (Relatório de Impacto à Proteção de Dados Pessoais) — **rascunho pronto** (`docs/rascunho-ripd.md`), falta **validação + assinatura do DPO** e **arquivamento formal**.
...
**Rascunho base já entregue:** `docs/transferencia-internacional-dados.md` (#116).
...
**Rascunho base já entregue:** `docs/rascunho-ripd.md` (#116).
...
*Documento de trabalho — insumo para os fundadores, a advogada e o DPO. Gated D4. Ver `docs/checklist-conformidade-juridica.md` e `docs/parecer-juridico-revisado-mp.md`.*
