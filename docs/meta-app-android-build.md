...
**Estabelecida:** 2026-07-01 · **Base:** `docs/plano-mobile-lojas.md` · **App:** `apps/mobile/` (Expo + React Native)
...
*Fonte da verdade da build-out do app. Ver `docs/plano-mobile-lojas.md`, `docs/STATUS.md`. Produção gated D4.*
