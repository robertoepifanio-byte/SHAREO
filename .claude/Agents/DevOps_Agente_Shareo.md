...
- Documentar os limites de escala do MVP e os gatilhos para evolução:
  - **Supabase Free Tier**: limite de 500MB de banco, 2GB de storage, 50.000 usuários ativos mensais — escalar quando atingir 70%.
  - **Vercel Hobby**: limite de 100GB de banda — migrar para Pro antes de campanhas de marketing.
  - **Edge Functions**: ativar para a busca geolocalizada quando a latência P95 ultrapassar 800ms.
- Planejar a migração para **infraestrutura multi-região** (Supabase + Vercel Edge) para H3 — com zero downtime de migração.
