...
export function FavoriteButton({ itemId, initialFavorited = false }: FavoriteButtonProps) {
  ...
  return (
    ...
    >
      <div className="flex h-7 w-7 items-center justify-center rounded-full bg-surface/90 shadow-sm" aria-hidden="true">
        <svg
          width="14" height="14" viewBox="0 0 24 24"
          className={faved ? "text-destructive" : "text-foreground"}
